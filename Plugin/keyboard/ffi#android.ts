export class VirtualKeyboardFFI implements Plaoc.IVirtualKeyboardFFI {
  private _ffi: Plaoc.VirtualKeyboardAndroidFFI = virtual_keyboard;

  getKeyboardSafeArea(): Promise<Plaoc.IKeyboardSafeArea> {
    return new Promise<Plaoc.IKeyboardSafeArea>((resolve, reject) => {
