...
object Share {
  ...
  fun share(
    ...
    val pi =
      PendingIntent.getBroadcast(App.appContext, 0, Intent(Intent.EXTRA_CHOSEN_COMPONENT), flags)
  ...
  private fun shareFiles(files: Array<String>, intent: Intent, onErrorCallback: (String) -> Unit) {
