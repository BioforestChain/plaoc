...
declare global {
    ...
    namespace Deno {
        namespace core {
             ...
             *     rid.
             */
            function setWasmStreamingCallback(cb: (source: any, rid: number) => void): void;
            /**
             ...
             */
            function setPromiseRejectCallback(cb: PromiseRejectCallback): undefined | PromiseRejectCallback;
             ...
             */
            function setUncaughtExceptionCallback(cb: UncaughtExceptionCallback): undefined | UncaughtExceptionCallback;
            type UncaughtExceptionCallback = (err: any) => void;
            /**
         ...
         * ```
         */
        function test(name: string, options: Omit<TestDefinition, "fn" | "name">, fn: (t: TestContext) => void | Promise<void>): void;
        /** Register a test which will be run when `deno test` is used on the command
         * line and the containing module looks like a test module.
         * `fn` can be async if required.
         *
         ...
         */
        function copy(src: Reader, dst: Writer, options?: {
            bufSize?: number;
        }): Promise<number>;
        /**
        ...
        /** A handle for `stdin`. */
        const stdin: Reader & ReaderSync & Closer & {
            readonly rid: number;
            readonly readable: ReadableStream<Uint8Array>;
        };
        /** A handle for `stdout`. */
        const stdout: Writer & WriterSync & Closer & {
            readonly rid: number;
            readonly writable: WritableStream<Uint8Array>;
        };
        /** A handle for `stderr`. */
        const stderr: Writer & WriterSync & Closer & {
            readonly rid: number;
            readonly writable: WritableStream<Uint8Array>;
        };
        ...
        type Signal = "SIGABRT" | "SIGALRM" | "SIGBREAK" | "SIGBUS" | "SIGCHLD" | "SIGCONT" | "SIGEMT" | "SIGFPE" | "SIGHUP" | "SIGILL" | "SIGINFO" | "SIGINT" | "SIGIO" | "SIGKILL" | "SIGPIPE" | "SIGPROF" | "SIGPWR" | "SIGQUIT" | "SIGSEGV" | "SIGSTKFLT" | "SIGSTOP" | "SIGSYS" | "SIGTERM" | "SIGTRAP" | "SIGTSTP" | "SIGTTIN" | "SIGTTOU" | "SIGURG" | "SIGUSR1" | "SIGUSR2" | "SIGVTALRM" | "SIGWINCH" | "SIGXCPU" | "SIGXFSZ";
        ...
        type PermissionName = "run" | "read" | "write" | "net" | "env" | "ffi" | "hrtime";
        ...
        type PermissionDescriptor = RunPermissionDescriptor | ReadPermissionDescriptor | WritePermissionDescriptor | NetPermissionDescriptor | EnvPermissionDescriptor | FfiPermissionDescriptor | HrtimePermissionDescriptor;
        ...
        type RecordType = "A" | "AAAA" | "ANAME" | "CAA" | "CNAME" | "MX" | "NAPTR" | "NS" | "PTR" | "SOA" | "SRV" | "TXT";
        ...
        function resolveDns(query: string, recordType: "A" | "AAAA" | "ANAME" | "CNAME" | "NS" | "PTR", options?: ResolveDnsOptions): Promise<string[]>;
        function resolveDns(query: string, recordType: "CAA", options?: ResolveDnsOptions): Promise<CAARecord[]>;
        function resolveDns(query: string, recordType: "MX", options?: ResolveDnsOptions): Promise<MXRecord[]>;
        function resolveDns(query: string, recordType: "NAPTR", options?: ResolveDnsOptions): Promise<NAPTRRecord[]>;
        function resolveDns(query: string, recordType: "SOA", options?: ResolveDnsOptions): Promise<SOARecord[]>;
        function resolveDns(query: string, recordType: "SRV", options?: ResolveDnsOptions): Promise<SRVRecord[]>;
        function resolveDns(query: string, recordType: "TXT", options?: ResolveDnsOptions): Promise<string[][]>;
        /**
         ...
         */
        function resolveDns(query: string, recordType: RecordType, options?: ResolveDnsOptions): Promise<string[] | CAARecord[] | MXRecord[] | NAPTRRecord[] | SOARecord[] | SRVRecord[] | string[][]>;
         ...
         * ```
         */
        function bench(name: string, options: Omit<BenchDefinition, "fn" | "name">, fn: () => void | Promise<void>): void;
        /** Register a bench which will be run when `deno bench` is used on the command
         * line and the containing module looks like a bench module.
         * `fn` can be async if required.
         *
        ...
        type NativeType = NativeNumberType | NativeBigIntType | NativePointerType | NativeFunctionType;
        type NativeResultType = NativeType | NativeVoidType;
        type ToNativeTypeMap = Record<NativeNumberType, number> & Record<NativeBigIntType, PointerValue> & Record<NativePointerType, TypedArray | PointerValue | null> & Record<NativeFunctionType, PointerValue | null>;
        ...
        type ToNativeResultType<T extends NativeResultType = NativeResultType> = ToNativeResultTypeMap[T];
        type ToNativeParameterTypes<T extends readonly NativeType[]> = [
            T[number][]
        ] extends [T] ? ToNativeType<T[number]>[] : [readonly T[number][]] extends [T] ? readonly ToNativeType<T[number]>[] : T extends readonly [...NativeType[]] ? {
            [K in keyof T]: ToNativeType<T[K]>;
        } : never;
        type FromNativeTypeMap = Record<NativeNumberType, number> & Record<NativeBigIntType, PointerValue> & Record<NativePointerType, PointerValue> & Record<NativeFunctionType, PointerValue>;
        ...
        type FromNativeResultTypeMap = FromNativeTypeMap & Record<NativeVoidType, void>;
        /** Type conversion for foregin symbol return types */
        type FromNativeResultType<T extends NativeResultType = NativeResultType> = FromNativeResultTypeMap[T];
        type FromNativeParameterTypes<T extends readonly NativeType[]> = [
            T[number][]
        ] extends [T] ? FromNativeType<T[number]>[] : [readonly T[number][]] extends [T] ? readonly FromNativeType<T[number]>[] : T extends readonly [...NativeType[]] ? {
        ...
        type StaticForeignSymbol<T extends ForeignFunction | ForeignStatic> = T extends ForeignFunction ? FromForeignFunction<T> : T extends ForeignStatic ? FromNativeType<T["type"]> : never;
        type FromForeignFunction<T extends ForeignFunction> = T["parameters"] extends readonly [] ? () => StaticForeignSymbolReturnType<T> : (...args: ToNativeParameterTypes<T["parameters"]>) => StaticForeignSymbolReturnType<T>;
        ...
        type ConditionalAsync<IsAsync extends boolean | undefined, T> = IsAsync extends true ? Promise<T> : T;
        ...
        interface UnsafeCallbackDefinition<Parameters extends readonly NativeType[] = readonly NativeType[], Result extends NativeResultType = NativeResultType> {
            parameters: Parameters;
            result: Result;
        }
        type UnsafeCallbackFunction<Parameters extends readonly NativeType[] = readonly NativeType[], Result extends NativeResultType = NativeResultType> = Parameters extends readonly [] ? () => ToNativeResultType<Result> : (...args: FromNativeParameterTypes<Parameters>) => ToNativeResultType<Result>;
        /**
         * **UNSTABLE**: Unsafe and new API, beware!
         *
        ...
        function run<T extends RunOptions & {
            clearEnv?: boolean;
            gid?: number;
            uid?: number;
        } = RunOptions & {
         ...
         * ```
         */
        function futimeSync(rid: number, atime: number | Date, mtime: number | Date): void;
        /** **UNSTABLE**: needs investigation into high precision time.
         *
         * Changes the access (`atime`) and modification (`mtime`) times of a file
         ...
         * ```
         */
        function futime(rid: number, atime: number | Date, mtime: number | Date): Promise<void>;
        /** **UNSTABLE**: new API, yet to be vetted.
         *
