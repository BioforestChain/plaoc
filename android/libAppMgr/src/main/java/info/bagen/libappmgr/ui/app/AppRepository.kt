...
import info.bagen.libappmgr.entity.AutoUpdateInfo
...
import info.bagen.libappmgr.ui.test.TestAppInfo
...
class AppRepository(private val api: ApiService = ApiService.instance) {
  ...
  private fun loadAppInfoListTest(): List<AppInfo> {
    ...
    list.add(createTemp("douyu","斗鱼", "http://linge.plaoc.com/douyu.png", "https://www.douyu.com/"))
    list.add(createTemp("wangyi","网易", "http://linge.plaoc.com/163.png", "https://www.163.com/"))
    list.add(createTemp("weibo","微博", "http://linge.plaoc.com/weibo.png", "https://weibo.com/"))
    list.add(createTemp("douban","豆瓣", "http://linge.plaoc.com/douban.png", "https://movie.douban.com/"))
    list.add(createTemp("zhihu","知乎", "http://linge.plaoc.com/zhihu.png", "https://www.zhihu.com/"))
    list.add(createTemp("bilibili","哔哩哔哩", "http://linge.plaoc.com/bilibili.png", "https://www.bilibili.com/"))
    list.add(createTemp("tencent","腾讯新闻", "http://linge.plaoc.com/tencent.png", "https://www.qq.com/"))
    list.add(createTemp("jingdong","京东", "http://linge.plaoc.com/jingdong.png", "https://www.jd.com/"))
    return list
  }

  private fun loadDAppUrlTest(appInfo: AppInfo): DAppInfoUI {
    return DAppInfoUI(appInfo.dAppUrl!!, appInfo.name, appInfo.iconPath, appInfo.dAppUrl!!, "1.1.1", false)
  }

  private fun createTemp(id: String, name: String, icon: String, url: String): AppInfo {
    return AppInfo(
      version = "1.0.0",
      bfsAppId = id,
      name = name,
