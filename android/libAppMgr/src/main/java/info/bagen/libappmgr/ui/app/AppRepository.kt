...
class AppRepository(private val api: ApiService = ApiService.instance) {
  ...
  private fun loadAppInfoListTest(): List<AppInfo> {
    ...
    list.add(createTemp("douyu","斗鱼", "http://linge.plaoc.com/douyu.png", "https://www.douyu.com/", "https://m.douyu.com/"))
    list.add(createTemp("wangyi","网易", "http://linge.plaoc.com/163.png", "https://www.163.com/", "https://3g.163.com/"))
    list.add(createTemp("weibo","微博", "http://linge.plaoc.com/weibo.png", "https://weibo.com/", "https://m.weibo.cn/"))
    list.add(createTemp("douban","豆瓣", "http://linge.plaoc.com/douban.png", "https://movie.douban.com/", "https://m.douban.com/movie/"))
    list.add(createTemp("zhihu","知乎", "http://linge.plaoc.com/zhihu.png", "https://www.zhihu.com/", "https://www.zhihu.com/"))
    list.add(createTemp("bilibili","哔哩哔哩", "http://linge.plaoc.com/bilibili.png", "https://www.bilibili.com/", "https://m.bilibili.com/"))
    list.add(createTemp("tencent","腾讯新闻", "http://linge.plaoc.com/tencent.png", "https://www.qq.com/", "https://xw.qq.com/?f=qqcom"))
  ...
  private fun createTemp(id: String, name: String, icon: String, url: String, appUrl: String): AppInfo {
    return AppInfo(
      version = "1.0.0",
      bfsAppId = id,
      name = name,
