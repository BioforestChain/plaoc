 ...
 * ```
 */
export declare function readRange(r: Deno.Reader & Deno.Seeker, range: ByteRange): Promise<Uint8Array>;
/**
 ...
 * ```
 */
export declare function readRangeSync(r: Deno.ReaderSync & Deno.SeekerSync, range: ByteRange): Uint8Array;
