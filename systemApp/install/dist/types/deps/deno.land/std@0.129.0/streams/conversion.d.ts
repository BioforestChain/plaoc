 ...
 * ```
 */
export declare function readerFromIterable(iterable: Iterable<Uint8Array> | AsyncIterable<Uint8Array>): Deno.Reader;
/** Create a `Writer` from a `WritableStreamDefaultWriter`. */
export declare function writerFromStreamWriter(streamWriter: WritableStreamDefaultWriter<Uint8Array>): Deno.Writer;
/** Create a `Reader` from a `ReadableStreamDefaultReader`. */
export declare function readerFromStreamReader(streamReader: ReadableStreamDefaultReader<Uint8Array>): Deno.Reader;
...
export declare function writableStreamFromWriter(writer: Deno.Writer, options?: WritableStreamFromWriterOptions): WritableStream<Uint8Array>;
 ...
 * ```
 */
export declare function readableStreamFromReader(reader: Deno.Reader | (Deno.Reader & Deno.Closer), options?: ReadableStreamFromReaderOptions): ReadableStream<Uint8Array>;
 ...
 * ```
 */
export declare function readAll(r: Deno.Reader): Promise<Uint8Array>;
 ...
 * ```
 */
export declare function readAllSync(r: Deno.ReaderSync): Uint8Array;
 ...
 * ```
 */
export declare function writeAll(w: Deno.Writer, arr: Uint8Array): Promise<void>;
 ...
 * ```
 */
export declare function writeAllSync(w: Deno.WriterSync, arr: Uint8Array): void;
 ...
 */
export declare function iterateReader(r: Deno.Reader, options?: {
    bufSize?: number;
 ...
 * next iteration will overwrite contents of previously returned chunk.
 */
export declare function iterateReaderSync(r: Deno.ReaderSync, options?: {
    bufSize?: number;
 ...
 */
export declare function copy(src: Deno.Reader, dst: Deno.Writer, options?: {
    bufSize?: number;
}): Promise<number>;
